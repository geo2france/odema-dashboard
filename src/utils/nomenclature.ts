...
export const chartBusinessProps = (item:string) : {label:string, color?:string, sort?:number} => {
    switch(item){
        ...
        case "Incinération sans valorisation":
        ...
        case "Valorisation énergétique":
            return {color:'#3995ff', sort:2, label:item}
        ...
        case "Valorisation matière inorganique":
        ...
        case "Valorisation matière organique":
...
export const ChartTerritoriesProps = (item:string) => {
    switch(item){
        case "02":
        case "Aisne":
            return { code: '02', color: '#CE73CA', libel: "Aisne" }
        case "80":
        case "Somme":
            return { code: '80', color: '#DEAD8F', libel: "Somme" }
        case "60":
        case "Oise":
            return { code: '60', color: "#C16C39", libel: "Oise" }
        case "59":
        case "Nord":
            return { code: '59', color: "#80218D", libel: "Nord" }
        case "62":
        case "Pas-de-Calais":
            return { code: '62', color: "#EFD9CB", libel: "Pas-de-Calais" }
    }
}